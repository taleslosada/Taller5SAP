sap.ui.define([
    ...
    return BaseController.extend("namespace1.productsmanager.controller.Worklist", {
        ...
        _showObject : function (oItem) {
            this.getRouter().navTo("object", {
                objectId: oItem.getBindingContext().getPath().substring("/SEPMRA_C_PD_Product".length)
            });
        },
